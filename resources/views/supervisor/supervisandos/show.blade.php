   ...
   <div class="ui grid">
     ...
     <div class="fourteen wide column">
       <div class="ui top attached tabular menu" onclick="tab()">
         <a class="item active" data-tab="first">Actas</a>
         <a class="item" data-tab="second">Dúvidas</a>
         <a class="item" data-tab="third">Versões de trabalho</a>
       </div>
     ...
     <div class="two wide column">
       <button class="ui teal button" onclick="model()"><i class="inbox icon"></i>Enviar mensagem</button>
     </div>
   </div>
</div>
@endsection
...
<div class="ui mini modal">
  ...
  <div class="header">Envia mensagem ao supervisando</div>
  <div class="content">
    <form class="ui form" action="#" method="post">
      ...
      <div class="field">
        ...
        <div class="field">
          <button type="submit" class="fluid ui green button" onsubmit="">Enviar</button>
        </div>
    </form>
  </div>
</div>
        ...
        <div class="inline fields">
          ...
          <div class="field">
            <div class="ui radio checkbox">
              ...
              <label>Válida (Aquela que contem situação real do encontro)</label>
            </div>
          </div>
          <div class="field">
            <div class="ui radio checkbox">
              <input name="estado" type="radio" value="Invalida">
              <label>Inválida</label>
            </div>
          </div>
        </div>
        <div class="field">
...
<div class="ui large modal">
  <i class="close icon"></i>
  <div class="header">Validar monografia</div>
  <div class="content">
    <form class="ui form" action="{{url('/feng/supervisores/'.$docente->id.'/supervisandos/'.$supervisao->id.'/monografias/validacao')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="inline fields">
          <label for="">Validação da monografia</label>
          <div class="field">
            <div class="ui radio checkbox">
              <input name="estado" checked="checked" type="radio" value="Valida">
              <label>Válida (Aquela que o supervisor reconhece como de mérito)</label>
            </div>
          </div>
          <div class="field">
            <div class="ui radio checkbox">
